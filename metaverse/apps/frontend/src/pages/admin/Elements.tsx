                ...
                >
                  ...
                  <CardContent className="p-4 space-y-3"> {/* Increased space-y */}
                    ...
                    <div className="flex items-center text-slate-300">
                        ...
                        <p><span className="font-medium">Dimensions:</span> {el.width} x {el.height}</p>
                    </div>
                    <div className="flex items-center text-slate-300">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-3 pt-2"> {/* Increased space-x and pt */}
                ...
                />
                <Label htmlFor="static" className="text-slate-300 flex items-center gap-2">
                    <SquareCheckBig className="h-4 w-4 text-purple-400" /> Static Element
                </Label>
              </div>
